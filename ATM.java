...
public class ATM
{
   public static void main(String[] args)
   {
      ...
      User aUser = theBank.addUser("Dave", "John", "1234");
   ...
   */
   ...
   public static User mainMenuPrompt(Bank theBank, Scanner sc)
   {
      ...
      //ask user for user ID/pin combo until a correct one is reached
      do 
      {
         System.out.printf("\n\nWelcome to %s\n\n", theBank.getName());
         ...
         //try to get the user object correspond to the ID and pin combo
   ...
   public static void printUserMenu(User theUser, Scanner sc)
   {
      ...
      do
      {
         ...
         {
            System.out.println("Invaild choice. Please choose 1-5");
         } 
      ...
      public static void showTransHistory(User theUser, Scanner sc)
      {
         ...
         //get the account that the user wants to look at 
         do
         {
